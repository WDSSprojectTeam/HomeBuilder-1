<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="HomeBuilder.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="HomeBuilder" %>
